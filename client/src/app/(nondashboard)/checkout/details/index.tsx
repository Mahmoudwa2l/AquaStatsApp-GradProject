...
const CheckoutDetailsPage = () => {
  ...
  if (isError) return <div>Failed to fetch project data</div>;
  if (!selectedCourse) return <div>Project not found</div>;
        ...
        <div className="checkout-details__options">
          <div className="checkout-details__guest">
            ...
            <p className="checkout-details__subtitle">
              Enter email to receive project access details and order
